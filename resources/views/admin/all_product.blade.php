      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img src="public/uploads/product/{{$pro->product_hinhanh}}" height="100px" width="100px"></td>
            ...
            <td>
              ...
              <a href="{{URL::to('/delete-product/'.$pro->product_id)}}" onclick="return confirm('Bạn có chắc xóa sản phẩm này không?')" class="active styling-edit" ui-toggle-class="">
